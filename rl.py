...
Universal code base for Raspberry Pi based Rooftop Lighting Modules.

1. Rooftop Lighting Control Module (CM)
2. Rooftop Lighting Distribution Module (DM)

The CM controls and monitors the 48VDC power supplies to the DMs.
The CM generates generates the lighting displays and commands the
DMs to control their individual light strings.

The DMs receive commands from the CM and turn their individual
lights on and off in response.
